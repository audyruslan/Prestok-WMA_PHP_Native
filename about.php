            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        ...
                        <h2>Prestok</h2>
                        <h3 class="text-center mt-2">Peramalan Stok Barang Menggunakan Metode BWME</h3>
                        ...
                        <p class="text-center mt-5">Prestok adalah sebuah aplikasi yang bertujuan untuk
                            membantu pengguna dalam melakukan prediksi atau perkiraan mengenai harga barang di masa yang
                            akan datang. Aplikasi ini menggunakan Metode BWME dan analisis data untuk
                            memproses informasi harga dari periode waktu sebelumnya dan memberikan prediksi harga untuk
                            ...
                            mengenai tren harga barang tersebut serta prediksi harga di masa depan.
